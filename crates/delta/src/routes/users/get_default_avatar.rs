use guilderia_rocket_okapi::guilderia_okapi::openapi3::{self, MediaType, RefOr};
...
impl guilderia_rocket_okapi::response::OpenApiResponderInner for CachedFile {
    fn responses(
        _gen: &mut guilderia_rocket_okapi::gen::OpenApiGenerator,
