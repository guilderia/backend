use guilderia_database::{util::reference::Reference, Database, PartialBot, User};
use guilderia_models::v0::{self, DataEditBot};
...
mod test {
    ...
    use guilderia_models::v0::{self, FieldsBot};
